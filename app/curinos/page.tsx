          ...
          <div className="relative z-10 flex-1 flex flex-col justify-center p-6 lg:p-10 max-w-7xl mx-auto text-white pt-16">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="space-y-6">
                ...
                <h3>
                    Developed scripts to automate manual test cases for key web application, improving test coverage and efficiency at the quality assurance stage. 
                </h3>

                 <h3>
                    Overhauled 100+ existing automated test cases, improving automation success rates from 65% to 98%, ensuring software quality and reliability.
                </h3>

                {/* Meta Information */}
                <div className="flex flex-wrap items-center gap-6 text-{#E3DEE0}">
                  <div className="flex items-center gap-2">
                    <p className="text-muted-foreground">September 2022 - December 2022</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-[#E3DEE0]">
                  <span className="font-semibold text-white">Role:</span> Technical QA Automation Engineering Co-op
                </div>
                ...
                <div className="space-y-1">
                  ...
                  <p>
                    Phython  • Jenkins • TestRail • Quality Assurance • Test Automation • Web Application Testing • API Testing • Agile Methodologies • Software Development Life Cycle (SDLC) • Technical Documentation
                  </p>
                </div>
              </div>
            </div>
