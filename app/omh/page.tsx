        ...
        <div className="flex h-16 shrink-0 items-center justify-between px-4 lg:px-6 relative z-20">
          ...
          <Breadcrumb>
            <BreadcrumbList>
              ...
              <BreadcrumbItem>
                <BreadcrumbPage className="text-white">Ontario Ministy of Health - Emergency Services</BreadcrumbPage>
              </BreadcrumbItem>
            </BreadcrumbList>
          </Breadcrumb>
          ...
          <div className="absolute inset-0 z-0">
            ...
            <div className="w-full h-full relative overflow-hidden">
              <Image
                ...
                alt="Toronto Emergency Services"
                fill
                priority
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
              ...
              <div className="space-y-6">
                <div className="space-y-2">
                  <h1 className="blog-title ">
                    Ontario Ministy of Health - Emergency Services Division
                  </h1>
                </div>
                
                <h3>
                    Reverse engineered and modernized a legacy VB6 plugin critical for the Computer-Aided Dispatch used by 9-1-1 operators. Refactored existing functionality to utilize internal API services. 
                </h3>

                {/* Meta Information */}
                <div className="flex flex-wrap items-center gap-6 text-{#E3DEE0}">
                  <div className="flex items-center gap-2">
                    <p className="text-muted-foreground">May 2025 - August 2025</p>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="text-[#E3DEE0]">
                  <span className="font-semibold text-white">Role:</span> Software Engineering Co-op
                </div>
